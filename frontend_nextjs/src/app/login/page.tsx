    ...
    <div className="flex h-screen items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 p-4">
      <div className="bg-gray-800/0 p-8 rounded-2xl shadow-2xl border border-gray-700/50 w-full max-w-md backdrop-blur-sm">
        ...
        <h1 className="text-2xl font-bold mb-2 text-center text-white">
          Welcome back to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-300">ChatApp</span>
        </h1>
        ...
        <button
          onClick={handleGoogleLogin}
          className="flex items-center justify-center gap-3 bg-white text-gray-800 p-2.5 rounded-lg hover:bg-gray-100 transition-all duration-300 font-medium mb-4 shadow-lg hover:shadow-gray-300/20 w-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="18"
        ...
        <div className="flex items-center my-6">
          ...
          <span className="mx-3 text-gray-400 text-sm font-light">or sign in with email</span>
          <div className="flex-grow border-t border-gray-600/50"></div>
        </div>
